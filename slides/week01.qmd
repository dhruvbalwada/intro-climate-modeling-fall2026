...
|---|---|---|
| Participation/attendance | 5% | in-class work (like today's slips), most weeks |
...
#### Submission process
All code in your own private GitHub repo; submitting = posting the folder or notebook link on Courseworks. **Lab 0 starts in a few minutes — today is hands-on.**
...
Follow the [Lab 0 instructions](https://dhruvbalwada.github.io/intro-climate-modeling-fall2026/labs/lab0.html) on the course website:
